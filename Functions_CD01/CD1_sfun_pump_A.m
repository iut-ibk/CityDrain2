...
% Date:			Origin: 01.07.2005, Last updated: 13.02.2006	
% Version		002
% Update content: 
% This version is corrected for dealing with concentration
% (numerical bug and C=0 for Q=0)
%=============================================================================
...
Cprime=[];
 ...
 % Component concentrations vector for Vi, Qe and Qw
if n_comp > 0
    if Vip > 0
        Cprime=(Cin.*qi.*tstep+C.*Vi)./Vip;
    else
        Cprime=zeros(n_comp,1);
    end 
end
...
sys=[Qw Cw' sum(Qpp) Cpp' Vii Cprime'];
